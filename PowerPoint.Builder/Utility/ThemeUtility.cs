...
public class ThemeUtility
{
    ...
    public ThemeUtility(SlideMasterPart slideMasterPart)
    {
        _slideMasterPart = slideMasterPart;
    }

    public ThemePart Build()
    {
        ThemePart themePart1 = _slideMasterPart.AddNewPart<ThemePart>("rId5");
